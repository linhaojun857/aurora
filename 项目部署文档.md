...
阿里云oss具体情况详见百度(如果有多余服务器空间，推荐minio作为对象存储，本人曾经被人恶意盗刷大量流量)
...
### 11.2 在/usr/local/nginx下创建nginx.conf文件，格式如下
